...
def test_tag_day():
    ...
    db.add_picture({'original': 'file1.jpg', 'name': 'name', 'key': '1', 'year': 2015, 'month': 12, 'day': 25}, ['phone', 'travel'])
    db.add_picture({'original': 'file2.jpg', 'name': 'name', 'key': '2', 'year': 2015, 'month': 12, 'day': 25}, ['phone', 'travel'])
    db.add_picture({'original': 'file3.jpg', 'name': 'name', 'key': '3', 'year': 2015, 'month': 12, 'day': 31}, ['phone', 'travel'])
...
def test_edit_picture_dates():
    ...
    db.add_picture({'original': 'file1.jpg', 'name': 'name', 'key': '1', 'year': 2015, 'month': 12, 'day': 25}, [])
    db.add_picture({'original': 'file1.jpg', 'name': 'name', 'key': '2', 'year': 2015, 'month': 12, 'day': 25}, [])
    db.add_picture({'original': 'file1.jpg', 'name': 'name', 'key': '3', 'year': 2015, 'month': 12, 'day': 25}, [])
