...
class TestPictureDetailRoute:
    ...
    def test_detail_shows_flickr_data(self, authenticated_client, sample_picture):
        ...
        flickr_data = {
            "id": "flickr123",
            "url": "https://flickr.com/photos/123",
        }
        db.pictures.edit_attribute(sample_picture["key"], "flickr", json.dumps(flickr_data))
    ...
    def test_detail_shows_gphotos_data(self, authenticated_client, sample_picture):
        ...
        db.pictures.edit_attribute(sample_picture["key"], "gphotos", json.dumps(gphotos_data))
